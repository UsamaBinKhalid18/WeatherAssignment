...
class Repository(dataBase: ReadingsDataBase) {
    ...
    suspend fun avgMaxTempForMonth(year:Int,month:Int)=readingsDao.avgMaxTempForMonth(year,month)

    suspend fun avgMinTempForMonth(year:Int,month:Int)=readingsDao.avgMinTempForMonth(year,month)

    suspend fun avgMeanHumForMonth(year:Int,month:Int)=readingsDao.avgMeanHumForMonth(year,month)
}